...
case class InternalResourceLoaderAdapter(private[amf] val adaptee: ClientResourceLoader)(implicit
...
case class ClientResourceLoaderAdapter(private[amf] val adaptee: ResourceLoader)(implicit
    executionContext: ExecutionContext
