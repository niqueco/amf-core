...
import amf.core.client.scala.model.domain.{DomainElement, LinkNode, Linkable, ExternalSourceElement}
import amf.core.client.scala.vocabulary.Namespace._
import amf.core.client.scala.vocabulary.{ValueType, Namespace}
