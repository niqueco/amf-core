...
import amf.core.internal.annotations.{Inferred, LexicalInformation, SourceAST, SourceNode, SynthesizedField, VirtualElement, SourceLocation => AmfSourceLocation}
