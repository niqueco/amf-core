...
/** Every client invocation to the parsing logic
  * @param url
  *   URL of the top level document being parsed
  */
...
/** Notifies when an [[AMFParsePlugin]] has been selected
  * @param rootLocation
  *   location of the document being parsed
  * @param plugin
  *   selected [[AMFParsePlugin]]
  */
...
/** Every successful parser invocation containing the top level domain unit being parsed
  ...
  *   URL of the top level document being parsed
  * @param unit
  *   parsed domain unit for the top level document
  */
...
/** Notifies when a [[TransformationPipeline]] starts
  * @param pipeline
  *   [[TransformationPipeline]] that's starting
  */
...
/** Notifies when a [[TransformationStep]] starts
  * @param step
  *   [[TransformationStep]] that's starting
  * @param index
...
/** Notifies when a [[TransformationStep]] finishes
  * @param step
  *   [[TransformationStep]] that finished
  * @param index
  *   index of the step in the pipeline
  */
...
/** Notifies Every time an [[AMFValidatePlugin]] finishes
  * @param plugin
  *   the [[AMFValidatePlugin]] that finished
  * @param result
  *   the resulting [[AMFValidationReport]]
  */
...
/** Notifies when starting to render to writer
  ...
  *   [[BaseUnit]] to render
  * @param mediaType
  *   optional mediatype to render to
  */
