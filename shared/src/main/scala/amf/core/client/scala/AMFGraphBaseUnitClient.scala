...
/** Contains common AMF graph operations associated to documents. Base client for <code>AMLBaseUnitClient</code> and
  * <code>AMFBaseUnitClient</code>.
  */
class AMFGraphBaseUnitClient private[amf] (protected val configuration: AMFGraphConfiguration) {
  ...
  /** Transforms a [[BaseUnit]] with the default configuration
    ...
    * @return
    *   An [[AMFResult]] with the transformed BaseUnit and it's report
    */
  ...
  /** Transforms a [[BaseUnit]] with a specific pipeline
    ...
    *   [[BaseUnit]] to transform
    * @param pipeline
    *   name of any custom or [[AMFGraphConfiguration.predefined predefined]] pipeline
    * @return
    *   An [[AMFResult]] with the transformed BaseUnit and it's report
    */
  ...
  /** Render a [[BaseUnit]] to a [[DocBuilder]] in the form of a graph (jsonld)
    ...
    *   [[BaseUnit]] to be rendered
    * @param builder
    *   [[DocBuilder]] which is used for rendering
    * @return
    *   The result produced by the DocBuilder after rendering
    */
  ...
  /** Validate a [[BaseUnit]] with its default validation profile name
    * @param baseUnit
    *   [[BaseUnit]] to validate
    * @return
    *   an [[AMFValidationReport]]
    */
