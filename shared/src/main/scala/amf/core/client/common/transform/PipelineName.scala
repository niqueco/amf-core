...
object PipelineName {
  ...
  /** Constructs a proper pipeline name given certain target media type and a pipeline id
    ...
    *   Provide a specification for obtaining the correct pipeline. Must be <code>"application/spec"</code> or
    *   <code>"application/spec+syntax"</code>. Examples: <code>"application/raml10"</code> or
    *   <code>"application/raml10+yaml"</code>
    * @param pipelineId
    *   must be one of the values defined in [[PipelineId]]
    * @return
