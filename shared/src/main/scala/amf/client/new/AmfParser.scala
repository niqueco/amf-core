...
object AmfParser {
  ...
  /**
    ...
    */
  def parse(url: String, env:AmfEnvironment): Future[AmfResult] = parseAsync(url)
  ...
  def parse(url: String, vendor:Vendor, env:BaseEnvironment): Future[AmfResult] = parseAsync(url)
  ...
  private[amf] def parseAsync(url: String,
                              ...
                              amfEnvironment: AmfEnvironment): Future[AmfResult] = {
